...
<head>
	...
	<style type="text/css">
		...
		#header {
			background-image: url(assets/wp-content/themes/footballclub/images/header.jpg);
			min-height: 140px;
		}
		...
		#menu .menu li:hover {
			...
			background-image: -webkit-gradient( linear, left top, left bottom, color-stop(0, #fc2837), color-stop(0.3, #ca0005), color-stop(1, #ca0005));
			background-image: -moz-linear-gradient( center top, #fc2837 0%, #ca0005 30%, #ca0005 100%);
			border-right-color: #840000;
			border-left-color: #d4000f;
		}
		...
		.sp-heading {
			background: #ca0005;
			background-image: -webkit-gradient( linear, left top, left bottom, color-stop(0, #d4000f), color-stop(1, #ac0000));
			background-image: -moz-linear-gradient( center top, #d4000f 0%, #ac0000 100%);
			filter: progid: DXImageTransform.Microsoft.gradient(startColorstr='#d4000f', endColorstr='#ac0000');
		}
		...
		.image-rotator .image_thumb ul li.active {
			background: #ca0005;
			background-image: -webkit-gradient( linear, left top, left bottom, color-stop(0, #d4000f), color-stop(1, #980000));
			background-image: -moz-linear-gradient( center top, #d4000f 0%, #980000 100%);
			filter: progid: DXImageTransform.Microsoft.gradient(startColorstr='#d4000f', endColorstr='#980000');
			cursor: default;
			border-color: #700000;
		}
		...
		#footer-widgets #footer-logo {
			background-image: url(assets/wp-content/themes/footballclub/images/footer-logo.png);
		}
	...
	<style type="text/css" id="custom-background-css">
		body.custom-background {
			background-image: url('assets/wp-content/themes/footballclub/images/background.jpg');
		...
		<nav id="menu" class="clearfix">
			<div class="menu-header">
				<ul id="menu-main-menu" class="menu">
					<li id="menu-item-396" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-2 current_page_item menu-item-396"><a href="assets/">Home</a></li>
					<li id="menu-item-597" class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-597"><a href="campaign.php">Campaña actual</a></li>
					<li id="menu-item-597" class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-597"><a href="tournaments.php">Otros torneos</a></li>
